...
\begin{DoxyCode}{0}
\DoxyCodeLine{54                      \{}
\DoxyCodeLine{62     \mbox{\hyperlink{classSocket_a7cf176290950fc3ddda59fc43e49f2ed}{sockfd\_}} = socket(AF\_INET, SOCK\_STREAM, 0);}
\DoxyCodeLine{63     \textcolor{keywordflow}{if} (\mbox{\hyperlink{classSocket_a7cf176290950fc3ddda59fc43e49f2ed}{sockfd\_}} == -\/1) \{}
\DoxyCodeLine{64         \textcolor{keywordflow}{throw} runtime\_error(\textcolor{stringliteral}{"{}Error: Failed to create socket"{}});}
\DoxyCodeLine{65     \}}
\DoxyCodeLine{66 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{71                                          \{}
\DoxyCodeLine{72     \mbox{\hyperlink{classSocket_a44059c2711bad07f9ff76ecdd3517dd4}{addr\_in\_}}.sin\_family      = AF\_INET;                    \textcolor{comment}{// IPv4}}
\DoxyCodeLine{73     \mbox{\hyperlink{classSocket_a44059c2711bad07f9ff76ecdd3517dd4}{addr\_in\_}}.sin\_port        = htons(port);                \textcolor{comment}{// Port}}
\DoxyCodeLine{74     \mbox{\hyperlink{classSocket_a44059c2711bad07f9ff76ecdd3517dd4}{addr\_in\_}}.sin\_addr.s\_addr = htonl(atoi(addr.c\_str()));  \textcolor{comment}{// Addres}}
\DoxyCodeLine{75 }
\DoxyCodeLine{76     \textcolor{comment}{// Binds socket to an address and port}}
\DoxyCodeLine{77     \textcolor{keywordflow}{if} (::\mbox{\hyperlink{classTcpSocket_a7d204a80b7c5dae21ee6c930db12b29d}{bind}}(\mbox{\hyperlink{classSocket_a7cf176290950fc3ddda59fc43e49f2ed}{sockfd\_}}, (\textcolor{keyword}{struct} sockaddr*)\&\mbox{\hyperlink{classSocket_a44059c2711bad07f9ff76ecdd3517dd4}{addr\_in\_}}, \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classSocket_a44059c2711bad07f9ff76ecdd3517dd4}{addr\_in\_}})) == -\/1) \{}
\DoxyCodeLine{78         \textcolor{keywordflow}{throw} runtime\_error(\textcolor{stringliteral}{"{}Error: Failed to bind socket"{}});}
\DoxyCodeLine{79     \}}
\DoxyCodeLine{80 }
\DoxyCodeLine{81     \textcolor{keywordflow}{return} \mbox{\hyperlink{classSocket_a7cf176290950fc3ddda59fc43e49f2ed}{sockfd\_}};}
\DoxyCodeLine{82 \}}
